 ...
 * the License.
 ******************************************************************************/
package com.odts.customer.controller;
...
import com.odts.customer.Customer;
import com.odts.customer.service.CustomerService;
...
public class CustomerController {
	...
	public ResponseEntity<Customer> createCustomer(@RequestBody Customer customerParam){
		log.info("Inside customerParam method" );
	...
	public ResponseEntity<Customer> updateCustomer(@PathVariable Long id,@RequestBody Customer customer){
		log.info("Inside updateCustomer method" );
		customer.setId(id);
